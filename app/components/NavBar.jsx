			    ...
			    >   
				  ...
				  <p id='bizName' 
				     ...
				     style={{'color': this.state.redLogo || rte === 'home'? '#DB4C3F' : 'white'}}>
				       <span id='havPar'>Havasu Parasail</span>
				  </p>
			    </NavItem>
			  </div>
		    </Navbar.Brand>   
		    <Navbar.Toggle id='toggleNav' ref='toggleDiv'/>
	      </Navbar.Header>
		
		  <Navbar.Collapse>
		    <Nav pullRight>
		      <NavItem eventKey={1} href="#" onClick={e => hashHistory.push('home')}>
		        <span id='navLinkTextfirst' style={{color: rte == 'home' ? '#DB4C3F' : 'white'}}> home </span>
		      </NavItem>
		      <NavItem eventKey={2} href="#" onClick={e => hashHistory.push('reservations')}>
		        <span id='navLinkTextSecond' style={{color: rte == 'reservations' ? '#DB4C3F' : 'white'}}> reservations </span>
		      </NavItem>		   
			  <NavItem eventKey={3} href="#" onClick={e => hashHistory.push('gallery')}>
		        <span id='navLinkText'style={{color: rte == 'gallery' ? '#DB4C3F' : 'white'}}> gallery </span>
		      </NavItem>
			  <NavItem eventKey={4} href="#" onClick={e => hashHistory.push('location')}>
		        <span id='navLinkText'style={{color: rte == 'location' ? '#DB4C3F' : 'white'}}> location </span>
		      </NavItem>
		      <NavItem eventKey={5} href="#" onClick={e => hashHistory.push('faq')}>
