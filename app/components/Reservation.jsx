  ...
  render() {
    return (
     ...
     <div id='bCW'>
              ...
              src="https://secure.webreserv.com/services/bookingcalendar.do?businessid=havasuparasailaz&embedded=y&search=0&avgrid=n&css=http://localhost:1337/webReserv.css"  frameBorder="0"
              >
                <a href="https://secure.webreserv.com/services/bookingcalendar.do?businessid=havasuparasailaz&embedded=y&search=0&avgrid=n&css=http://localhost:1337/webReserv.css">Make Reservation</a>
              </iframe>
      </div>
